...
(function () {
  ...
  const CSS = `
    ...
    .mkw-logo { position: absolute; left: 50%; transform: translateX(-50%); display: flex; align-items: center; gap: 10px; text-decoration: none; }
    .mkw-logo__icon { width: 32px; height: 32px; border: 1px solid #888; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .mkw-logo__dot { width: 13px; height: 13px; background: #2a4fa8; }
    .mkw-logo__text { font-family: 'Open Sans', sans-serif; font-size: 16px; font-weight: 600; letter-spacing: 0.18em; color: #111; text-transform: uppercase; }
